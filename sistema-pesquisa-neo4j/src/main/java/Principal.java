...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        PublicacaoModel publicacaoModel = new PublicacaoModel(driver);
    ...
    private static int menu() {
        System.out.println("\n============================================== MENU =============================================\n");
        System.out.println("SUGESTÃO: Antes de realizar qualquer operação que exija o ID do registro, verifique o mesmo através das listagens\n");
